...
const DashboardLayout = () => {
  return (
    <div className="flex flex-col md:flex-row h-screen w-full bg-background overflow-hidden relative">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-primary/5 rounded-full blur-[80px] pointer-events-none -z-10"></div>

      <Sidebar />
      
      <main className="flex-1 h-full overflow-y-auto custom-scrollbar p-4 pb-24 md:p-8 md:pb-8">
